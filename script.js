...
(function () {
    ...
    // ========================================================================
    // SOCKET LISTENERS & ADMIN LOCKDOWN
    // ========================================================================
    ...
    // ========================================================================
    // NTFY.SH PUSH NOTIFICATION ENGINE
    // ========================================================================
    ...
    function renderRoster() {
        DOM.rosterList.innerHTML = STATE.group.map(p => {
            ...
            let actionBtns = "";
            // Admins can eject anyone. Workers can only eject themselves.
            ...
            // You can ONLY track your OWN device's GPS. Admin cannot remotely turn on worker's GPS.
            if (isMe) {
