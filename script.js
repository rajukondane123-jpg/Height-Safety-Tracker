...
(function () {
    ...
    // Fix for "undefined" or blank cached inputs
    let savedSettings = {};
    ...
    // --- PERFECTED SMART SCALING GRAPH WITH INCREASED PADDING ---
    function renderGraph() {
        if(!DOM.graphSvg) return;
        const W = DOM.graphSvg.clientWidth || 1000; const H = DOM.graphSvg.clientHeight || 600; 
        
        // INCREASING VERTICAL PADDING TO PREVENT TEXT CUTOFF AT THE VERY TOP
